...
export const allEvents: Event[] = [
  ...
  { id: '041', title: 'ADVANCED BACKOFFICE CUSTOMIZATION', type: 'WORKSHOP', speaker: 'ANITA_SHARMA', date: 'OCT 15, 2024', time: '14:00 IST', location: 'KERALA_HUB', status: 'ARCHIVED', description: 'Hands-on workshop on creating custom property editors and dashboard extensions for the Umbraco backoffice.' },
